...
public abstract class CollidingGameObject extends GameObject {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(hitBoxRectangle, other.hitBoxRectangle) && Double.compare(hitBoxOffsetX, other.hitBoxOffsetX) == 0 && Double.compare(hitBoxOffsetY, other.hitBoxOffsetY) == 0 && Double.compare(hitBoxOffsetWidth, other.hitBoxOffsetWidth) == 0 && Double.compare(hitBoxOffsetHeight, other.hitBoxOffsetHeight) == 0;

    }

    @Override
    public int hashCode() {
        return Objects.hash(hitBoxRectangle, hitBoxOffsetX, hitBoxOffsetY, hitBoxOffsetWidth, hitBoxOffsetHeight);
    }
    */
}
