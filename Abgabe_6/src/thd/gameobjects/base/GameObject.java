...
public abstract class GameObject {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(speedInPixel, other.speedInPixel) == 0 && rotation == other.rotation && size == other.size && width == other.width && height == other.height && Objects.equals(position, other.position) && Objects.equals(targetPosition, other.targetPosition);
    }

    @Override
    public int hashCode() {
       return Objects.hash(speedInPixel, rotation, size, width, height, position, targetPosition);
    }
}