...
public class Time extends GameObject {
    ...
    public Time(GameView gameView, GamePlayManager gamePlayManager) {
        ...
        this.rotation = 0;
        this.height = 33;
        position.updateCoordinates(1100, 20);
        this.distanceToBackground = 6;
    }
    ...
    public void addToCanvas() {
        gameView.addTextToCanvas("TIME " + gameView.gameTimeInMilliseconds()/1000, position.getX(), position.getY(), 20, true, Color.WHITE, 0, "font.ttf");
    }
}
